  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <ThemedText style={[styles.body, { color: C.fadedInk }]}>By accessing or using Lasu ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</ThemedText>

        <ThemedText serif style={[styles.heading, { color: C.ink }]}>2. Description of Service</ThemedText>
        <ThemedText style={[styles.body, { color: C.fadedInk }]}>Lasu is an AI-powered personal assistant that communicates via SMS and a companion application. The Service processes your messages, extracts and stores information you share, and responds on your behalf.</ThemedText>
        ...
        <ThemedText style={[styles.body, { color: C.fadedInk }]}>By providing your phone number and verifying it through our application, you expressly consent to receive recurring SMS messages from Lasu at the phone number you provided. These messages include responses from your AI agent, verification codes, and service-related notifications. Message frequency varies based on your usage. Message and data rates may apply. Your consent to receive SMS messages is not a condition of purchasing any goods or services, but is required to use the Service as SMS is the primary communication channel. You may revoke your consent and opt out of receiving SMS messages at any time by texting STOP to the Lasu phone number. After opting out, you will receive a final confirmation message and no further SMS messages will be sent. You may text START to re-subscribe. For help, text HELP or contact support@getlasu.com.</ThemedText>
        ...
        <ThemedText style={[styles.body, { color: C.fadedInk }]}>In no event shall Lasu be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service.</ThemedText>

        <ThemedText serif style={[styles.heading, { color: C.ink }]}>12. Contact</ThemedText>
        <ThemedText style={[styles.body, { color: C.fadedInk }]}>For questions about these Terms, contact us at legal@getlasu.com.</ThemedText>
      </ScrollView>
    </SafeAreaView>
  )
}
