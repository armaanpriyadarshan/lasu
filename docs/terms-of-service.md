...
The Service uses artificial intelligence to generate responses. AI-generated content may be inaccurate, incomplete, or inappropriate. You acknowledge that:
- Responses are not professional advice (legal, medical, financial, or otherwise)
- You are responsible for evaluating and acting on any information provided
- The Service does not guarantee the accuracy of any response
